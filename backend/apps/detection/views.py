...
class YoloModelListView(APIView):
    """
    List all YOLO models for an organization
    GET /api/v1/detection/yolo-models/?org_code=ACME
    """
    ...
    def get(self, request):
        ...
        models = CustomYoloModel.objects.filter(organization=org, is_active=True)
    ...
    def post(self, request):
        ...
        try:
            ...
            if active_yolo and YOLO_AVAILABLE:
                ...
                # Use SMART COMPLIANCE RULES (complex logic)
                from .compliance_rules import check_full_compliance
                compliance_result = check_full_compliance(detections)
