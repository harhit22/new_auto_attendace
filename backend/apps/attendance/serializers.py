...
from core.models import SaaSAttendance, SaaSEmployee
...
class EmployeeSerializer(serializers.ModelSerializer):
    """Serializer for SaaSEmployee."""
    
    class Meta:
        model = SaaSEmployee
        fields = [
            'id', 'employee_id', 'first_name', 'last_name', 
            'email', 'phone', 'department', 'designation', 'role',
            'face_enrolled', 'image_count', 'image_status',
            'password', 'created_at', 'organization'
        ]
        read_only_fields = ['id', 'face_enrolled', 'image_count', 'image_status', 'created_at']
        extra_kwargs = {
            'organization': {'required': False},  # Usually set by view
            'password': {'read_only': True}       # Password generated by backend only?
        }
